                            ...
                            <#if basePageResult.totalCount == 0>
                                ...
                                <#else >
                                    ...
                                    <#list startPage..endPage as n>
                                        <li <#if basePageResult.pageNum==n>class="active" </#if> ><a <#if basePageResult.pageNum==n><#else >href="/index?pageNum=${n}<#if query4object.good??>&good=true</#if><#if query4object.newest??>&newest=true</#if><#if query4object.zeroComment??>&zeroComment=true</#if><#if query4object.keyWord??>&keyWord=${query4object.keyWord}</#if>"</#if> >${n}</a></li>
                                    </#list>
